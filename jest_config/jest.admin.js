{
    ...
    "testPathIgnorePatterns": [
        "<rootDir>/admin/config", "<rootDir>/client"
    ],
    "moduleNameMapper": {
        ...
        "^actions$": "<rootDir>/admin/actions",
        "^reducers$": "<rootDir>/admin/reducers",
        "^routing": "<rootDir>/admin/routing",
        "^components$": "<rootDir>/admin/components",
        "^containers$": "<rootDir>/admin/containers",
        "^config$": "<rootDir>/admin/config/test.js"
    }
}
